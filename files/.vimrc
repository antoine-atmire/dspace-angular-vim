...
nnoremap <leader>Tt :e %:r.spec.ts<cr>
" navigate from spec file
nnoremap <leader>Ti :e %:r:r.ts<cr>
" navigate to .ts file
nnoremap <leader>Tc :e %:r.ts<cr>
" navigate to html
nnoremap <leader>Th :e %:r.html<cr>
" navigate to .service.ts
nnoremap <leader>Ts :e %:r:r.service.ts<cr>
" navigate to .effects.ts
nnoremap <leader>Te :e %:r:r.effects.ts<cr>
